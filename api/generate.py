...
"""
            ...
            if regenerate and previous_result:
...
같은 음악을 사용하면서
활동 이름만 바꾸거나,
같은 활동의 표현만 조금 바꾸는 방식은
피해 주세요.

입력된 대상 연령, 수업 시간,
수업 주제, 난이도, 음악 개념,
활동 유형, 교수법 등의 조건은 유지하면서
새로운 관점의 수업으로 설계해 주세요.
...
사용자가 직접 지정한 클래식 음악
'{classical_title}'은 반드시 그대로 사용해 주세요.

클래식 작품 자체는 변경하지 않습니다.
